...
const SiderBondsListItem = ({data, index, btnDelete, setPaymentArrFn, creatingPaginationFn , btnChangeChart, setDisplayShowCalc}) => {
...
export default SiderBondsListItem;