...
const SiderLoansListItem = ({data, index, btnDelete, setPaymentArrFn, creatingPaginationFn , btnChangeChart, setDisplayShowCalc}) => {
...
export default SiderLoansListItem;