        ...
        return (
            <div className={"sider"}>
                ...
                <ul className={"siderHistory-calcList"}>
                    ...
                    <li className={"siderHistory-calcList-item contrastColor"}><span></span><span>2023.04.01 | 14%</span><span><img src={"pictures/arrow_drop_down_circle_FILL0_wght400_GRAD0_opsz48.svg"} style={{width: "20px", height: "20px"}} /><button className={"thirdColor"}>--</button></span></li>
                    <li className={"siderHistory-calcList-item contrastColor"}><span></span><span>2023.04.01 | 14%</span><span><FaBeer/><FaArchive/><img src={"pictures/arrow_drop_down_circle_FILL0_wght400_GRAD0_opsz48.svg"} style={{width: "20px", height: "20px"}} /><button className={"thirdColor"}>--</button></span></li>
                </ul>
